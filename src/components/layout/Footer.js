      ...
      <footer className="bg-gray-800 text-white py-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-bold mb-4">GTMS</h3>
              <p className="text-gray-400 mb-4">
                Gem Trade Management System: The specialized B2B/B2C e-commerce platform for the Sri Lankan gem and jewelry industry.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/gemstones" className="text-gray-400 hover:text-white">Gemstones</a></li>
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">Subscribe to our newsletter for the latest gemstone updates and offers.</p>
          ...
          <div className="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {currentYear} Gem Trade Management System. All rights reserved.
            </p>
            <div className="flex space-x-4">
